...
export const translations = {
  en: {
    ...
    about: {
      ...
      paragraphs: [
        'Olen tietojärjestelmätieteen maisteriopiskelija Vaasan yliopistosta ja valmistun keväällä 2026. Taustallani on jo kauppatieteiden kandidaatin tutkinto. Opinnoissani olen perehtynyt IT-infrastruktuurin, tiedonhallinnan ja järjestelmäintegraatioiden perusteisiin, ja olen täydentänyt tätä käytännön kokemuksella suurissa yrityksissä.',
